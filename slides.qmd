...
format:
  revealjs:
    ...
    footer: "[Home](/) | [Source](https://github.com/mfisher87/presentation-geo-education-summit-2025) | [geojupyter.org](https://geojupyter.org)"
    auto-stretch: true
    slide-number: true
---
...
::::::{.column width=25%}
:::{style="font-size: 90%"}
![[https://mfisher87.github.io/presentation-geo-education-summit-2025](https://mfisher87.github.io/presentation-geo-education-summit-2025)](/assets/images/qr.svg){width=100%}
:::
::::::
:::::::::
...
Because geospatial data is important to everyone but not equally accessible to
everyone, we believe it needs to be democratized. So...
...
We want to hear from you, and I'll share how at the end.
:::
...
:::notes
We believe open source and open science are critical to our effort to
democratize geospatial data practice, so everything we do is free and open.
